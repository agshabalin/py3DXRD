...
class GrainSpotter:
    ...
    def __init__(self, directory = None):
        ...
        self.add_to_log('Created GrainSpotter object.', True)
    ...
    def load_ini(self, directory = None, ini_file = None):
        ...
        self.add_to_log(f'Reading file: {self.directory+self.ini_file}', True)
        ...
        with open(self.directory+self.ini_file, "r") as f:
            for line in f:
                ...
                if ('spacegroup' in words[0]):
                    ...
                    self.set_attr('cuts', [int(words[1]), float(words[2]), float(words[3])])
    ...
    def save_ini(self, directory = None, ini_file = None, overwrite = False):
        ...
        self.add_to_log(f'Writing file: {self.directory+self.ini_file}', True)
    ...
    def run_grainspotter(self, directory = None, ini_file = None, gve_file = None, log_file = None):
        ...
        if del_old > 0: self.add_to_log(f"Deleted old .log .gff .ubi files.", True)
...
# G = GrainSpotter(directory='/asap3/petra3/gpfs/p21.2/2021/data/11008399/processed/CS_1/load1/z_00/')
# G.load_ini(ini_file='V4_peaks_merged.ini')
# G.run_grainspotter(ini_file='V4_peaks_merged_test.ini')
# G.print(True)